...
//        mSwipeRefreshLayout.setRefreshing(false);
    ...
    public  void plotGraph(String ac, String inc, View view){
        ...
        decoView.addSeries(new SeriesItem.Builder(Color.rgb(242, 24, 46))
                .setRange(0, 100, 100)
                .setInitialVisibility(false)
                .setLineWidth(39f)
                .build());

        SeriesItem seriesItem1 = new SeriesItem.Builder(Color.rgb(69, 175, 17))
                .setRange(0, total, 0)
                .setLineWidth(29f)
        ...
        client.get(getActivity(), POINTS_REQUEST_URL , new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                   ...
                   String s="(2x"+String.valueOf(Correct)+") - (1x"+String.valueOf(Wrong)+")";
                    formula.setText(s);
