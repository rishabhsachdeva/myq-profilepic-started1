...
public class SignUpActivity extends Activity {
    ...
    private EditText Name, Email, Password, ReferralCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> user_details = sessionManager.getUserDetails();
        id = user_details.get(SessionManager.KEY_UID);
        ...
        referral_textView = (TextView) findViewById(R.id.haveareferral);
        ...
        referral_textView.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ImageButton check=(ImageButton) findViewById(R.id.showhidecheck);
...
//
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String referralCodeValue = ReferralCode.getText().toString().trim();

                Log.e("email Value: ", email);
                Log.e("Referral code Value: ", referralCodeValue);
                ...
                if (email.equals("")) {
                    ...
                    if (isValidEmail(email)) {
                        register(email, password, name, referralCodeValue);
                    } else {
    ...
    public void register(String emailaddress, String password, String username, String Rcode){
        ...
        try {
            ...
            jsonParams.put("referralcode", Rcode);
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                if (responseString != null) {
                    ...
                    try {
                        ...
                        Log.e("response OBJECT: ", String.valueOf(jsonOnject));
                        ...
                        {
                            ////////////////////////////////////shitcontinues//////////////
                            final Toast toast = Toast.makeText(getApplicationContext(), "Account Successfully Created", Toast.LENGTH_SHORT);
                            toast.show();
                            ...
                            Toast.makeText(SignUpActivity.this, "Verify your email to login", Toast.LENGTH_SHORT).show();

                            Log.e("Please call locationapi","");

                         //   locationapifn();
                            Log.e("just called locationapi","");
                            Intent intent = new Intent(SignUpActivity.this, LoginActivity.class);
                            startActivity(intent);
                        }
                    }
...
//        editor.putString("reader2", ""+reader2);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (response.length() > 0) {
                        ...
                        sessionManager.createLoginSession(_id, username, profilepicture, emai, aboutme, dob, gender,college);
    ...
    private void FirebaseregisterUser() {

        //creating a new user
        Log.d("Firebaseemail",n);
        Log.d("Firebasepassword",p);

        firebaseAuth.createUserWithEmailAndPassword(n, p)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        //checking if success
                        if(task.isSuccessful()){
                            Log.d("success in firebase","");
                  //          Toast.makeText(SignUpActivity.this,"Registration success",Toast.LENGTH_LONG).show();
                            finish();
                        }else{

                            Log.d("failure in firebase","");
       ...
       /* firebaseAuth.createUserWithEmailAndPassword(n, p)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        //checking if success
                        if (task.isSuccessful()) {
                            Toast.makeText(SignUpActivity.this, "Firebase Successfully registered", Toast.LENGTH_LONG).show();
                        }
                        if(!task.isSuccessful()) {
                            Toast.makeText(SignUpActivity.this, "Firebase Registration Error", Toast.LENGTH_LONG).show();
                            try {
                                throw task.getException();
                            } catch(FirebaseAuthWeakPasswordException e) {
                                Log.e("firefuck", e.getMessage());
