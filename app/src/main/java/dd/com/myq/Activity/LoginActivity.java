...
//                        reader2,
                ...
                sessionManager.createLoginSession(Config.uid, Config.username, Config.profilePic, Config.useremail, Config.aboutMe, Config.dob, Config.gender,Config.CollegeName);
                Intent i = new Intent(LoginActivity.this, HomeActivity.class);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(i);
...
//        editor.putString("reader2", ""+reader2);
    ...
    public void locationapifn(String _id)
    {
   //     Toast.makeText(LoginActivity.this, "locationapifncalled", Toast.LENGTH_SHORT).show();

        AsyncHttpClient client1 = new AsyncHttpClient();
        RequestParams requestParams1 = new RequestParams();
        requestParams1.put("id",_id);
        Log.d("Id=",_id);

        if(lat==null||lng==null)
        {
            lat= String.valueOf(28.55);
            lng= String.valueOf(77.11);

        }

        requestParams1.put("lattitude", lat);
        requestParams1.put("longitude", lng);
        String UpdateLocation="http://myish.com:10011/api/updatelocation";
        Log.d("yahaan hun main=: ", "1");

        client1.post(this,UpdateLocation, requestParams1, new JsonHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject responseString) {
                ...
                Log.d("SuccessUpdate=: ", responseString.toString());
            }
            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                super.onFailure(statusCode, headers, throwable, errorResponse);
                Log.e("FailUpdate1=: ", errorResponse.toString());
            }
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                super.onFailure(statusCode, headers, responseString, throwable);
                Log.e("FailUpdate2=: ", responseString.toString());
            }
            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject responseString) {
                super.onFailure(statusCode, headers, throwable, responseString);
                Log.e("FailUpdate3=: ", responseString.toString());
            }
        });
    }
}