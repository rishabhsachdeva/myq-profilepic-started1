...
public class SessionManager {
    ...
    public void createLoginSession(String uid, String username,String profile_pic,String email,String aboutme,String dob,String gender,String college){
        ...
        editor.putString(KEY_COLLEGE_NAME, college);

        editor.commit();
    }

    public void UpdateLoginSession(String uid, String username,String email,String aboutme,String dob,String gender,String college){
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        user.put(KEY_COLLEGE_NAME, pref.getString(KEY_COLLEGE_NAME, null));
